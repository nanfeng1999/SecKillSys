...
func isEmptyBody(e *httpexpect.Expect, username string, page int, resp *httpexpect.Response) {
...
func isNonEmptyCoupons(e *httpexpect.Expect, username string, page int, resp *httpexpect.Response) {
	e.GET(getCouponPath, username).
		WithQuery(pageQueryKey, page).
		WithHeader("Authorization", resp.Header("Authorization").Raw()).
		Expect().
...
func isGetCouponUnauthorized(e *httpexpect.Expect, username string, page int, resp *httpexpect.Response) {
...
// 验证符合顾客的格式
func isCustomerSchema(e *httpexpect.Expect, username string, page int, resp *httpexpect.Response) {
...
// 验证符合商家的格式
func isSellerSchema(e *httpexpect.Expect, username string, page int, resp *httpexpect.Response) {
	e.GET(getCouponPath, username).WithQuery(pageQueryKey, page).
		WithHeader("Authorization", resp.Header("Authorization").Raw()).
...
// 验证优惠券的剩余量与预期一致
func isCouponExpectedLeft(e *httpexpect.Expect, username string, page int, index int, expectedLeft int, resp *httpexpect.Response)  {
	e.GET(getCouponPath, username).WithQuery(pageQueryKey, page).
		WithHeader("Authorization", resp.Header("Authorization").Raw()).
